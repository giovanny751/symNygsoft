...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            var input = $('<input type="text" class="' + search_init + sCSSClass + '" value="' + inputvalue + '" rel="' + i + '" name="' + inputvalue + '"/>');
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected) {
            ...
            var r = '<select class="search_init select_filter" rel="' + i + '" name="' + sLabel + '"><option value="" class="search_init">' + sLabel + '</option>';
            var j = 0;
