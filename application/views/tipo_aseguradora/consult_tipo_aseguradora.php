<div class="row">
    <a href="<?php echo base_url() . "index.php/Tipo_aseguradora/index" ?>"><div class="circuloIcon" title="Nuevo Tipo aseguradora" ><i class="fa fa-folder-open fa-3x"></i></div></a>
        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>CREAR TIPO DE ASEGURADORA
                    </div>
                    <div class="tools">
