    ...
    <div class="col-md-12">
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                <div class="form-body">
                    <form action="<?php echo base_url('index.php/') . '/Preguntas/consult_preguntas'; ?>" method="post" class="form-horizontal">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="eva_id" class="col-md-4">Evaluación</label>
                                <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <label for="tipPre_id" class="col-md-4">Tipo pregunta</label>
                                <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <label for="pre_nombre" class="col-md-4">Pregunta</label>
                                <div class="col-md-8">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-bordered">
                    <div class="row">
                        <div class="col-md-12 preguntaModal" id="tipo_pre"></div>
                        <div class="col-md-12 preguntaModal" id="contex_pre"></div>
                        <div class="col-md-12 preguntaModal" id="nombre_pre"></div>
                        <div class="col-md-12 preguntaModal" id="body_pre"></div>
                        <div class="col-md-12 preguntaModal" id="respuesta_pre"></div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $('.modificar').click(function () {
        var pre_visible = ($(this).attr('estado') == "S") ? 'N' : 'S';
