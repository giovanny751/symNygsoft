    ...
    <div class="col-md-12">
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                <div class="form-body">
                    <div class="row">
                        <form method="post" id="indicador" class="form-horizontal">
                            <div class="col-lg-6 col-md-6 col-sx-6 col-sm-6 ">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="nombreindicador" class="col-md-4  control-label">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="mide" class="col-md-4 control-label ">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="dimensionuno" class="col-md-4 control-label">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="dimensiondos" class="col-md-4 control-label">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="frecuencia" class="col-md-4  control-label">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="nombreempleado" class="col-md-4  control-label">
                                ...
                                <div class="row">    
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="minimo" class="col-md-4 control-label">
                                                Valor mínimo
                                            </label>
                                            <div class="col-md-8">   
                                ...
                                <div class="row">  
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="maximo" class="col-md-4  control-label">
                                                Valor máximo
                                            </label> 
                                            <div class="col-md-8 ">   
                            ...
                            <div class="col-lg-6 col-md-6 col-sx-6 col-sm-6 ">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="estado" class="col-md-4 control-label">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="objetivo" class="col-md-4 control-label">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="meta" class="col-md-4 control-label">
                                                Meta
                                            </label>
                                            <div class="col-md-8">   
